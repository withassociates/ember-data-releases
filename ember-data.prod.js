(function() {
    ...
    */
    ...
    var ember$data$lib$core$$DS = Ember.Namespace.create({
      VERSION: '1.0.0-beta.18+canary.0ef340fb6e'
    });
    ...
    function ember$data$lib$system$store$finders$$_findMany(adapter, store, typeClass, ids, records) {
      ...
      return promise.then(function(adapterPayload) {
        return store._adapterRun(function() {
          ...
          return ember$data$lib$system$store$finders$$map(records, function(record) { return record.reference; });
        });
    ...
    */
    ...
    var ember$data$lib$system$many$array$$default = Ember.Object.extend(Ember.MutableArray, Ember.Evented, {
      ...
      */
      ...
      replace: function(idx, amt, objects) {
        ...
        if (objects) {
          this.get('relationship').addRecords(ember$data$lib$system$many$array$$map(objects, function(obj) { return obj.reference; }), idx);
        }
      },
      /**
    ...
    ember$data$lib$system$relationships$state$has$many$$ManyRelationship.prototype.findRecords = function() {
      ...
      //TODO CLEANUP
      return this.store.findMany(ember$data$lib$system$relationships$state$has$many$$map(manyArray.toArray(), function(rec) { return rec.reference; })).then(function() {
        //Goes away after the manyArray refactor
    ...
    */
    ...
    function ember$data$lib$system$reference$$splitOnDot(name) {
      return ember$data$lib$system$reference$$_splitOnDotCache[name] || (
        (ember$data$lib$system$reference$$_splitOnDotCache[name] = name.split('.'))
      );
    }

    function ember$data$lib$system$reference$$extractPivotName(name) {
      return ember$data$lib$system$reference$$_extractPivotNameCache[name] || (
        (ember$data$lib$system$reference$$_extractPivotNameCache[name] = ember$data$lib$system$reference$$splitOnDot(name)[0])
      );
    }
    ...
    ember$data$lib$system$store$$Store = ember$data$lib$system$store$$Service.extend({
      ...
      */
      ...
      scheduleFetchMany: function(records) {
        var references = ember$data$lib$system$store$$map(records, function(record) { return record.reference; });
